  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <p className="text-brand-dust">Connect your wallet to view race history</p>
        <WalletConnect />
      </div>
    )
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-brand-dust mt-1">Your last 20 race results</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {[
          { label: 'Total Races', value: String(summary.totalRaces), color: 'text-brand-ink' },
          ...
          >
            <p className="text-brand-dust text-sm mb-1">{card.label}</p>
